...
TEST_P(evm, eip2929_case1)
{
    ...
    rev = EVMC_SHANGHAI;
    msg.sender = "Z0000000000000000000000000000000000000000"_address;
    msg.recipient = "Z000000000000000000000000636F6E7472616374"_address;
    const bytecode code =
    ...
    EXPECT_EQ(r[2], "Z0000000000000000000000000000000000000001"_address);
    EXPECT_EQ(r[3], "Z0000000000000000000000000000000000000001"_address);
    EXPECT_EQ(r[4], "Z0000000000000000000000000000000000000002"_address);
    EXPECT_EQ(r[5], "Z0000000000000000000000000000000000000002"_address);
    EXPECT_EQ(r[6], "Z0000000000000000000000000000000000000003"_address);
    EXPECT_EQ(r[7], "Z0000000000000000000000000000000000000003"_address);
    EXPECT_EQ(r[8], "Z00000000000000000000000000000000000000f1"_address);
    EXPECT_EQ(r[9], "Z00000000000000000000000000000000000000f1"_address);
    EXPECT_EQ(r[10], "Z00000000000000000000000000000000000000f2"_address);
    EXPECT_EQ(r[11], "Z00000000000000000000000000000000000000f2"_address);
    EXPECT_EQ(r[12], "Z00000000000000000000000000000000000000f3"_address);
    EXPECT_EQ(r[13], "Z00000000000000000000000000000000000000f3"_address);
    EXPECT_EQ(r[14], "Z00000000000000000000000000000000000000f2"_address);
    EXPECT_EQ(r[15], "Z00000000000000000000000000000000000000f2"_address);
    EXPECT_EQ(r[16], "Z00000000000000000000000000000000000000f3"_address);
    EXPECT_EQ(r[17], "Z00000000000000000000000000000000000000f3"_address);
    EXPECT_EQ(r[18], "Z00000000000000000000000000000000000000f1"_address);
    EXPECT_EQ(r[19], "Z00000000000000000000000000000000000000f1"_address);
    EXPECT_EQ(r[20], "Z0000000000000000000000000000000000000000"_address);
    EXPECT_EQ(r[21], "Z0000000000000000000000000000000000000000"_address);
...
TEST_P(evm, eip2929_case2)
{
    ...
    EXPECT_EQ(r[0], msg.sender);
    EXPECT_EQ(r[1], msg.recipient);
    EXPECT_EQ(r[2], "Z00000000000000000000000000000000000000ff"_address);
    EXPECT_EQ(r[3], "Z00000000000000000000000000000000000000ff"_address);
...
TEST_P(evm, eip2929_delegatecall_cold)
{
    ...
    EXPECT_EQ(r[0], msg.sender);
    EXPECT_EQ(r[1], msg.recipient);
    EXPECT_EQ(r[2], "Z00000000000000000000000000000000000000de"_address);
