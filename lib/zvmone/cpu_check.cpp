...
#define CPU_FEATURE "x86-64-v" STRINGIFY(ZVMONE_X86_64_ARCH_LEVEL)
#else
...
#if ZVMONE_X86_64_ARCH_LEVEL == 2
#define CPU_FEATURE "sse4.2"
#elif ZVMONE_X86_64_ARCH_LEVEL == 3
#define CPU_FEATURE "avx2"
#endif
#endif

#ifndef CPU_FEATURE
#error "ZVMONE_X86_64_ARCH_LEVEL: Unsupported x86-64 architecture level"
#endif
